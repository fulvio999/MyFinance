                 ...
                 Button {
                     ...
                     onClicked: {
                         ...
                         if(customRangeChartListModel.count === 0){
                             chartTitleLabel.text= "<b>"+i18n.tr("NO DATA FOUND")+"</b>"+i18n.tr("from: ")+Utility.formatDateToString(from)+ " to: "+Utility.formatDateToString(to)+" (date format is yyyy-mm-dd)"
                         }else{

            ...
            onClicked: {
                ...
                if (reportTypeModel.get(reportTypeItemSelector.selectedIndex).name === "<b>Instant Report</b>") {
                    ...
                    if(lastMonthChartListModel.count === 0){
                        ...
                        chartTitleLabel.text= "<b>"+i18n.tr("Monthly report from:  ")+Utility.formatDateToString(monthAgo)+ i18n.tr("  to:")+Utility.formatDateToString(today)+"</b><br/>"+" (date format is yyyy-mm-dd)"
                        chartTitleLabelContainer.visible = true;
                    }
                     ...
                     Button {
                         ...
                         onClicked: {
                             ...
                             if(customRangeChartListModel.count === 0){
                                chartTitleLabel.text= "<b>+"+i18n.tr("NO DATA FOUND")+"</b>from: "+Utility.formatDateToString(from)+ " to: "+Utility.formatDateToString(to)+"<br/> (date format is yyyy-mm-dd)"
                             }else{

...
UBUNTU_TRANSLATION_DOMAIN="myfinance.fulvio"
...
aptest.commands = bash $$PWD/MyFinance/tests/autopilot/run
aptest.depends  = sub-MyFinance

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/MyFinance/tests/unit 
unittest.depends  = sub-MyFinance

...
//--------------- For PHONE Page with application settings and maintenance utility ---------------
...
Column{
    ...
    Row{
         ...
         Label{
            text: "<b>GENERAL SETTINGS (** Restart is required after update ** )</b>"
            fontSize: "small"
         }
    }
    ...
    Row{
        ...
        Label{
            text: "<b>MAINTENANCE:</b> Remove expences for a category and subCategory.<br/>There is NO restore !"
            fontSize: "small"
        }
    }

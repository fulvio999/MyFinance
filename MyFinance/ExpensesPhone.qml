...
Column {
    ...
    Component {
        ...
        OperationSuccessResult{msg:"Amount inserted successfully"}
    }
       ...
       Component {
        ...
        Row{
            ...
            TextArea {
                ...
                text: ""
                height: units.gu(15)
                width: amountRow.width - units.gu(6)
                readOnly: false
            }
        }
    ...
    Row{
        ...
        anchors.horizontalCenter: expensesTabletPageLayout.horizontalCenter
        ...
        Button {
            ...
            width: units.gu(18)
            iconName: "edit"
            onTriggered: adaptivePageLayout.addPageToNextColumn(categoryExpensePage, categoryEditPage,
                                                                {
        ...
        Button {
            ...
            width: units.gu(17)
            iconName: "find"
            onClicked: adaptivePageLayout.addPageToNextColumn(categoryExpensePage, findExpensePage,
                                                                {
                                                                    /* <page-variable-name>:<property-value-to-pass> */
                                                                    categoryName:categoryExpensePage.categoryName,
                                                                    categoryId:categoryExpensePage.id

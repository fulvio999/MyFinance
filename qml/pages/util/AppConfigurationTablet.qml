...
Column{
    ...
    Row{
         ...
         Label{
             text: "<b>"+i18n.tr("GENERAL SETTINGS (** Restart required after update ** )")+"</b>"
         }
    }
    ...
    Row{
        ...
        Label{
            text: "<b>"+i18n.tr("MAINTENANCE")+":</b>"+i18n.tr("Remove expences for a category (and his subCategory). There is NO restore !")
        }
    }
